\chapter{State Machine Design}
\hypertarget{md__c_1_2_users_2namph_2_downloads_2openssl_2openssl-3_82_81_2ssl_2statem_2_r_e_a_d_m_e}{}\label{md__c_1_2_users_2namph_2_downloads_2openssl_2openssl-3_82_81_2ssl_2statem_2_r_e_a_d_m_e}\index{State Machine Design@{State Machine Design}}
This file provides some guidance on the thinking behind the design of the state machine code to aid future maintenance.

The state machine code replaces an older state machine present in Open\+SSL versions 1.\+0.\+2 and below. The new state machine has the following objectives\+:
...
Conceptually the state machine component is designed as follows\+: \begin{DoxyVerb}                      libssl
                         |
-------------------------|-----statem.h------------------------------------
                         |
